# Authentication REST API with Node.js, TypeScript, Typegoose & Zod Boilerplate

inspired and updated from [TomDoesTech](https://github.com/TomDoesTech/auth-api-tutorial/tree/main)
